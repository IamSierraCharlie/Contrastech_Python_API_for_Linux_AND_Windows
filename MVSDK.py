...
GENICAM_Camera_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera))
GENICAM_Camera_getType = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera))
GENICAM_Camera_getName = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_getKey = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_connect = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera), c_int)
GENICAM_Camera_disConnect = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera))
GENICAM_Camera_isConnect = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera))
GENICAM_Camera_getInterfaceName = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_getInterfaceType = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera))
GENICAM_Camera_downLoadGenICamXML = eval('CFUNCTYPE')(c_int, POINTER(GenicamCamera), c_char_p)
GENICAM_Camera_getVendorName = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_getModelName = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_getSerialNumber = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
GENICAM_Camera_getDeviceVersion = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamCamera))
...
GENICAM_Frame_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamFrame))
GENICAM_Frame_clone = eval('CFUNCTYPE')(POINTER(GenicamFrame), POINTER(GenicamFrame))
GENICAM_Frame_reset = eval('CFUNCTYPE')(None, POINTER(GenicamFrame))
GENICAM_Frame_valid = eval('CFUNCTYPE')(c_int, POINTER(GenicamFrame))
GENICAM_Frame_getImage = eval('CFUNCTYPE')(c_void_p, POINTER(GenicamFrame))
GENICAM_Frame_getFrameStatus = eval('CFUNCTYPE')(c_uint, POINTER(GenicamFrame))
GENICAM_Frame_getImageWidth = eval('CFUNCTYPE')(c_uint, POINTER(GenicamFrame))
GENICAM_Frame_getImageHeight = eval('CFUNCTYPE')(c_uint, POINTER(GenicamFrame))
GENICAM_Frame_getImageSize = eval('CFUNCTYPE')(c_uint, POINTER(GenicamFrame))
GENICAM_Frame_getImagePixelFormat = eval('CFUNCTYPE')(c_int, POINTER(GenicamFrame))
GENICAM_Frame_getImageTimeStamp = eval('CFUNCTYPE')(c_ulonglong, POINTER(GenicamFrame))
GENICAM_Frame_getBlockId = eval('CFUNCTYPE')(c_ulonglong, POINTER(GenicamFrame))
GENICAM_Frame_getPayLoadTypes = eval('CFUNCTYPE')(c_int, POINTER(GenicamFrame), c_int * MAX_PAYLOAD_TYPE_CNT,
                                                  POINTER(c_uint))
...
callbackFunc = eval('CFUNCTYPE')(None, POINTER(GenicamFrame))

# SDK.h => void(*callbackFunEx)(GENICAM_Frame* pFrame, void* pUser);
callbackFuncEx = eval('CFUNCTYPE')(None, POINTER(GenicamFrame), c_void_p)
...
GENICAM_StreamSource_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource))
GENICAM_StreamSource_startGrabbing = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), c_ulonglong, c_int)
GENICAM_StreamSource_stopGrabbing = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource))
GENICAM_StreamSource_isGrabbing = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource))
GENICAM_StreamSource_getFrame = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), POINTER(POINTER(GenicamFrame)),
                                                  c_uint)
GENICAM_StreamSource_attachGrabbing = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), callbackFunc)
GENICAM_StreamSource_detachGrabbing = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), callbackFunc)
GENICAM_StreamSource_setBufferCount = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), c_uint)
GENICAM_StreamSource_attachGrabbingEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), callbackFuncEx,
                                                          c_void_p)
GENICAM_StreamSource_detachGrabbingEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamStreamSource), callbackFuncEx,
                                                          c_void_p)
...
connectCallBack = eval('CFUNCTYPE')(None, POINTER(GenicamSConnectArg))

# SDK.h => void (*connectCallBackEx)(const GENICAM_SConnectArg* pConnectArg, void* pUser)
connectCallBackEx = eval('CFUNCTYPE')(None, POINTER(GenicamSConnectArg), c_void_p)

# SDK.h => void (*paramUpdateCallBack)(const GENICAM_SParamUpdataArg* pParamUpdateArg)
paramUpdateCallBack = eval('CFUNCTYPE')(None, POINTER(GenicamSParamUpdataArg))

# SDK.h => void (*paramUpdateCallBackEx)(const GENICAM_SParamUpdataArg* pParamUpdateArg, void* pUser)
paramUpdateCallBackEx = eval('CFUNCTYPE')(None, POINTER(GenicamSParamUpdataArg), c_void_p)

# SDK.h => void (*streamCallBack)(const GENICAM_SStreamArg* pStreamArg)
streamCallBack = eval('CFUNCTYPE')(None, POINTER(GenicamSStreamArg))

# SDK.h => void (*streamCallBackEx)(const GENICAM_SStreamArg* pStreamArg, void *pUser)
streamCallBackEx = eval('CFUNCTYPE')(None, POINTER(GenicamSStreamArg), c_void_p)

# SDK.h => void (*msgChannelCallBackEx)(const GENICAM_SMsgChannelArg* pMsgChannelArg, void *pUser)
msgChannelCallBackEx = eval('CFUNCTYPE')(None, POINTER(GenicamSMsgChannelArg), c_void_p)
...
GENICAM_EventSubscribe_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe))
GENICAM_EventSubscribe_subscribeConnectArgs = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe), connectCallBack)
GENICAM_EventSubscribe_unsubscribeConnectArgs = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                  connectCallBack)
GENICAM_EventSubscribe_subscribeParamUpdate = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                paramUpdateCallBack)
GENICAM_EventSubscribe_unsubscribeParamUpdate = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                  paramUpdateCallBack)
GENICAM_EventSubscribe_subscribeStreamArg = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe), streamCallBack)
GENICAM_EventSubscribe_unsubscribeStreamArg = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe), streamCallBack)
GENICAM_EventSubscribe_subscribeConnectArgsEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                  connectCallBackEx, c_void_p)
GENICAM_EventSubscribe_unsubscribeConnectArgsEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                    connectCallBackEx, c_void_p)
GENICAM_EventSubscribe_subscribeParamUpdateEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                  paramUpdateCallBackEx, c_void_p)
GENICAM_EventSubscribe_unsubscribeParamUpdateEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                    paramUpdateCallBackEx, c_void_p)
GENICAM_EventSubscribe_subscribeStreamArgEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                streamCallBackEx, c_void_p)
GENICAM_EventSubscribe_unsubscribeStreamArgEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
                                                                  streamCallBackEx, c_void_p)
GENICAM_EventSubscribe_subscribeMsgChannelEx = eval('CFUNCTYPE')(c_int, POINTER(GenicamEventSubscribe),
...
GENICAM_GigECamera_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamGigECamera))
GENICAM_GigECamera_getIpAddress = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigECamera))
GENICAM_GigECamera_getSubnetMask = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigECamera))
GENICAM_GigECamera_getGateway = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigECamera))
GENICAM_GigECamera_getMacAddress = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigECamera))
GENICAM_GigECamera_forceIpAddress = eval('CFUNCTYPE')(c_int, POINTER(GenicamGigECamera), c_char_p, c_char_p, c_char_p)
GENICAM_GigECamera_getAccessPermission = eval('CFUNCTYPE')(c_int, POINTER(GenicamGigECamera))
...
GENICAM_GigEInterface_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamGigEInterface))
GENICAM_GigEInterface_getDescription = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigEInterface))
GENICAM_GigEInterface_getIpAddress = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigEInterface))
GENICAM_GigEInterface_getSubnetMask = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamGigEInterface))
...
GENICAM_UsbCamera_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getConfigurationValid = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getGenCPVersion = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getU3VVersion = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getDeviceGUID = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getFamilyName = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getU3VSerialNumber = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_isLowSpeedSupported = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_isFullSpeedSupported = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_isHighSpeedSupported = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_isSuperSpeedSupported = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbCamera))
GENICAM_UsbCamera_getSpeed = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbCamera))
...
GENICAM_UsbInterface_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamUsbInterface))
GENICAM_UsbInterface_getDescription = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbInterface))
GENICAM_UsbInterface_getVendorID = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbInterface))
GENICAM_UsbInterface_getDeviceID = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbInterface))
GENICAM_UsbInterface_getSubsystemID = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbInterface))
GENICAM_UsbInterface_getRevision = eval('CFUNCTYPE')(c_char_p, POINTER(GenicamUsbInterface))
...
GENICAM_IntNode_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode))
GENICAM_IntNode_getValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode), POINTER(c_longlong))
GENICAM_IntNode_setValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode), c_longlong)
GENICAM_IntNode_getMinVal = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode), POINTER(c_longlong))
GENICAM_IntNode_getMaxVal = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode), POINTER(c_longlong))
GENICAM_IntNode_isValid = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode))
GENICAM_IntNode_isAvailable = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode))
GENICAM_IntNode_isReadable = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode))
GENICAM_IntNode_isWriteable = eval('CFUNCTYPE')(c_int, POINTER(GenicamIntNode))
...
GENICAM_DoubleNode_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode))
GENICAM_DoubleNode_getValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode), POINTER(c_double))
GENICAM_DoubleNode_setValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode), c_double)
GENICAM_DoubleNode_getMinVal = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode), POINTER(c_double))
GENICAM_DoubleNode_getMaxVal = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode), POINTER(c_double))
GENICAM_DoubleNode_isValid = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode))
GENICAM_DoubleNode_isAvailable = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode))
GENICAM_DoubleNode_isReadable = eval('CFUNCTYPE')(c_int, POINTER(GenicamDoubleNode))
...
GENICAM_BoolNode_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode))
GENICAM_BoolNode_getValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode), POINTER(c_uint))
GENICAM_BoolNode_setValue = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode), c_uint)
GENICAM_BoolNode_isValid = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode))
GENICAM_BoolNode_isAvailable = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode))
GENICAM_BoolNode_isReadable = eval('CFUNCTYPE')(c_int, POINTER(GenicamBoolNode))
...
GENICAM_AcquisitionControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_acquisitionFrameCount = eval('CFUNCTYPE')(GenicamIntNode,
                                                                     POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_acquisitionFrameRate = eval('CFUNCTYPE')(GenicamDoubleNode,
                                                                    POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_acquisitionFrameRateEnable = eval('CFUNCTYPE')(GenicamBoolNode,
                                                                          POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_acquisitionMode = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_exposureAuto = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_exposureMode = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_exposureTime = eval('CFUNCTYPE')(GenicamDoubleNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_triggerActivation = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_triggerDelay = eval('CFUNCTYPE')(GenicamDoubleNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_triggerMode = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_triggerSelector = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
GENICAM_AcquisitionControl_triggerSource = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAcquisitionControl))
...
GENICAM_UserSetControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamUserSetControl))
GENICAM_UserSetControl_restoreDefault = eval('CFUNCTYPE')(c_int, POINTER(GenicamUserSetControl))
GENICAM_UserSetControl_setCurrentUserSet = eval('CFUNCTYPE')(c_int, POINTER(GenicamUserSetControl), c_int)
GENICAM_UserSetControl_saveUserSet = eval('CFUNCTYPE')(c_int, POINTER(GenicamUserSetControl), c_int)
GENICAM_UserSetControl_getCurrentUserSet = eval('CFUNCTYPE')(c_int, POINTER(GenicamUserSetControl))
...
GENICAM_ISPControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamISPControl))
GENICAM_ISPControl_brightness = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamISPControl))
GENICAM_ISPControl_sharpness = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamISPControl))
GENICAM_ISPControl_sharpnessAuto = eval('CFUNCTYPE')(GenicamBoolNode, POINTER(GenicamISPControl))
GENICAM_ISPControl_sharpnessEnable = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamISPControl))
GENICAM_ISPControl_contrast = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamISPControl))
GENICAM_ISPControl_hue = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamISPControl))
...
GENICAM_AnalogControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_blackLevelSelector = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_blackLevelAuto = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_blackLevel = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_gainAuto = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_gainRaw = eval('CFUNCTYPE')(GenicamDoubleNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_gamma = eval('CFUNCTYPE')(GenicamDoubleNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_balanceRatioSelector = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAnalogControl))
GENICAM_AnalogControl_balanceWhiteAuto = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamAnalogControl))
...
GENICAM_DigitalIOControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamDigitalIOControl))
GENICAM_DigitalIOControl_lineSelector = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamDigitalIOControl))
GENICAM_DigitalIOControl_lineDebouncerTimeAbs = eval('CFUNCTYPE')(GenicamDoubleNode, POINTER(GenicamDigitalIOControl))
GENICAM_DigitalIOControl_userOutputSelector = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamDigitalIOControl))
...
GENICAM_TransportLayerControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamTransportLayerControl))
...
GENICAM_ImageFormatControl_release = eval('CFUNCTYPE')(c_int, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_height = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_width = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_offsetX = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_offsetY = eval('CFUNCTYPE')(GenicamIntNode, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_pixelFormat = eval('CFUNCTYPE')(GENICAM_EnumNode, POINTER(GenicamImageFormatControl))
GENICAM_ImageFormatControl_reverseX = eval('CFUNCTYPE')(GenicamBoolNode, POINTER(GenicamImageFormatControl))
