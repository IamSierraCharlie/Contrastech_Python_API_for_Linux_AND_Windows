...
camera.property_getset("DeviceReset", 'Execute')

camera.property_getset("DeviceUserID", 'Camera')
...
while True:
    ...
    res = camera.property_getset("DeviceTemperature", None)
    print(f"Temp reported is {res}")
